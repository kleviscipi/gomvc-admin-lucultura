...
//error_reporting(0);
$obj = new CreateSystem();

$class_controller = (isset($argv[1]))?($argv[1]):'Myfile';
$tablecolumns = (isset($argv[2]))?($argv[2]):'Mydb';

$obj->SystemFiles($class_controller,$tablecolumns);

class CreateSystem
{

	public $path_url 		= '/home/junio/Documents/jobs/github/gomvc-admin-lucultura/App'; //THIS IS THE PATH OF YOUR PPROJECT
	public $url 			=  '/vendor/autoload.php';

	public  function SystemFiles($class_controller='',$tablecolumns ='',$DB_TYPE = "POSTGRES"){

		$fullpath = $this->path_url;
		define("ROOT",$fullpath ); //THIS PATH IS USED ON ALL , SET YOUR PATH
